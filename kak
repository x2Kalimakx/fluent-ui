...
local aa = {
    function()
        ...
        local w = u("XesonzHub", {Parent = i:IsStudio() and j.PlayerGui or game:GetService "CoreGui"})
        v(w)
        t:Init(w)
        local x = {
            Version = "1.1.0",
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Crimson", "Xesonz"}}
    ...
    [54] = function()
        ...
        return {
            ...
            Element = Color3.fromRGB(195, 153, 148),
            ElementBorder = Color3.fromRGB(158, 123, 119),
            InElementBorder = Color3.fromRGB(91, 71, 68),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(90, 45, 45),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(90, 45, 45),
            DropdownFrame = Color3.fromRGB(158, 107, 100),
            DropdownHolder = Color3.fromRGB(40, 10, 10),
            DropdownBorder = Color3.fromRGB(25, 0, 0),
            DropdownOption = Color3.fromRGB(90, 45, 45),
            Keybind = Color3.fromRGB(90, 45, 45),
